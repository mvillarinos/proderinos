  ...
  <div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
      <div>
        ...
        <p class="text-slate-600 mt-2 text-lg">Set up a new pelota paleta tournament</p>
      </div>
      <UButton 
        to="/tournaments"
        variant="outline"
    ...
    <div class="max-w-4xl mx-auto">
      <div class="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-emerald-50 to-teal-50 px-8 py-6 border-b border-emerald-100">
          <div class="flex items-center gap-4">
            ...
            <div>
              <h2 class="text-2xl font-bold text-slate-800">Tournament Details</h2>
              <p class="text-slate-600">Fill in the information to create your tournament</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-8">
          ...
          >
            ...
            <div class="space-y-3">
              ...
              />
              <p class="text-xs text-slate-500">Choose a descriptive name for your tournament</p>
            </div>
            ...
            <div class="space-y-3">
              ...
              <UTextarea 
                ...
                placeholder="Provide additional details about the tournament (optional)"
                :rows="4"
                size="lg"
                class="transition-all duration-200 focus:ring-2 focus:ring-blue-500"
              />
              <p class="text-xs text-slate-500">Optional: Add tournament rules, prizes, or other important information</p>
            </div>
            ...
            <div class="space-y-6">
              <div class="flex items-center gap-2">
                ...
                <h3 class="text-lg font-semibold text-slate-800">Tournament Schedule</h3>
              </div>
              ...
              <div class="bg-purple-50 border border-purple-200 rounded-xl p-4">
                <p class="text-purple-800 text-sm">
                  💡 <strong>Tip:</strong> Setting dates helps participants plan ahead. You can always update them later.
                </p>
              </div>
            </div>
            ...
            <div class="space-y-4">
              <div class="flex items-center gap-2">
                ...
                <h3 class="text-lg font-semibold text-slate-800">Tournament Status</h3>
              </div>
              ...
              <div class="space-y-3">
                ...
                >
                  <template #leading>
                    <UIcon name="i-heroicons-flag" class="w-4 h-4 text-amber-600" />
                  </template>
                </USelectMenu>
              </div>
              ...
              <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                <p class="text-amber-800 text-sm">
                  📋 <strong>Recommended:</strong> Start with "Draft" status to set up teams and matches before going live.
                </p>
              </div>
            </div>
      ...
      <!-- Help Section -->
      <div class="mt-8 bg-gradient-to-r from-slate-50 to-blue-50 rounded-2xl p-6 border border-slate-200">
        <div class="flex items-start gap-4">
          <div class="w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0">
            <UIcon name="i-heroicons-light-bulb" class="w-5 h-5 text-blue-600" />
          </div>
          <div>
            <h3 class="font-semibold text-slate-800 mb-2">Next Steps</h3>
            <ul class="text-slate-600 text-sm space-y-1">
              <li>• After creating the tournament, you'll be able to add participating teams</li>
              <li>• Generate match brackets automatically or create them manually</li>
              <li>• Track results and standings throughout the tournament</li>
              <li>• Update the status as the tournament progresses</li>
            </ul>
          </div>
        </div>
      </div>
