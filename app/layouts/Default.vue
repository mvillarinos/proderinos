      ...
      <UContainer>
        <div class="flex items-center justify-between py-2">
          ...
          <div class="flex items-center space-x-3 cursor-pointer" @click="$router.push('/')">
            <div class="size-8 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg flex items-center justify-center shadow-lg">
              <UIcon name="custom:paleta" class="w-5 h-5 text-white fill-white" />
            </div>
            <div>
              <h1 class="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                Proderinos
              </h1>
              <p class="text-xs text-slate-500 -mt-1">Gestión de torneos</p>
            </div>
          </div>
          <!-- Navigation Links -->
    ...
    <footer class="bg-white/80 backdrop-blur-sm border-t border-slate-200 mt-16">
      <UContainer>
        <div class="py-6 flex flex-col sm:flex-row justify-between items-center text-sm text-slate-500">
          <p>&copy; 2025 Proderinos. Gestión de torneos.</p>
          <p class="mt-2 sm:mt-0">Desarrollado por Manuel Villarinos usando Nuxt y Tailwind CSS</p>
        </div>
      </UContainer>
    </footer>
  </div>
